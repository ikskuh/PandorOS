...
#define YY_ACTTAB_COUNT (119)
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    82,   18,   19,   16,   17,   15,   14,   13,   28,   12,
 /*    10 */    11,   10,    9,    8,    7,   37,   18,   19,   16,   17,
 /*    20 */    15,   14,   13,   23,   12,   11,   10,    9,    8,    7,
 /*    30 */    22,   18,   19,   16,   17,   15,   14,   13,    2,   12,
 /*    40 */    11,   10,    9,    8,    7,   79,   20,   21,   32,   67,
 /*    50 */    21,  108,   97,   16,   17,   15,   14,   13,   96,   12,
 /*    60 */    11,   10,    9,    8,    7,   81,   95,    5,   21,   34,
 /*    70 */    94,   93,   92,    4,   29,   12,   11,   10,    9,    8,
 /*    80 */     7,   35,   33,    6,   30,   70,   71,   72,   15,   14,
 /*    90 */    13,   84,   12,   11,   10,    9,    8,    7,    5,   31,
 /*   100 */    26,   27,   24,   25,    4,    1,   74,   83,    3,   36,
 /*   110 */    80,   80,   35,   80,    6,   80,   70,   71,   72,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    1,    2,    3,    4,    5,    6,    7,   25,    9,
 /*    10 */    10,   11,   12,   13,   14,   15,    1,    2,    3,    4,
 /*    20 */     5,    6,    7,   25,    9,   10,   11,   12,   13,   14,
 /*    30 */    25,    1,    2,    3,    4,    5,    6,    7,   23,    9,
 /*    40 */    10,   11,   12,   13,   14,   24,   25,   25,   26,   19,
 /*    50 */    25,   26,   25,    3,    4,    5,    6,    7,   25,    9,
 /*    60 */    10,   11,   12,   13,   14,    0,   25,    2,   25,   26,
 /*    70 */    25,   25,   25,    8,   25,    9,   10,   11,   12,   13,
 /*    80 */    14,   16,   17,   18,   25,   20,   21,   22,    5,    6,
 /*    90 */     7,    0,    9,   10,   11,   12,   13,   14,    2,   25,
 /*   100 */    25,   25,   25,   25,    8,   16,   19,    0,   18,   16,
 /*   110 */    27,   27,   16,   27,   18,   27,   20,   21,   22,   27,
 /*   120 */    27,   27,   27,   27,   27,   27,   27,   27,   27,   27,
 /*   130 */    27,   27,   27,   27,   24,   24,   24,   24,   24,   24,
 /*   140 */    24,   24,   24,
};
...
static const unsigned char yy_shift_ofst[] = {
 /*     0 */    65,   96,   96,   96,   96,   96,   96,   96,   96,   96,
 /*    10 */    96,   96,   96,   96,   96,   96,   96,   96,   96,   96,
 /*    20 */     0,   15,   30,   50,   50,   50,   83,   83,   66,   66,
 /*    30 */    66,   66,   91,   89,   87,   90,  107,   93,
};
#define YY_REDUCE_COUNT (19)
#define YY_REDUCE_MIN   (-17)
#define YY_REDUCE_MAX   (78)
static const signed char yy_reduce_ofst[] = {
 /*     0 */    21,   22,   25,   43,  -17,   -2,    5,   27,   33,   41,
 /*    10 */    45,   46,   47,   49,   59,   74,   75,   76,   77,   78,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    78,  106,  106,  106,   78,   78,   78,   78,   78,   78,
 /*    10 */    78,   78,   78,   78,   78,   78,   78,   78,   78,   78,
 /*    20 */    78,  107,   78,   99,   86,   85,   88,   87,  100,   91,
 /*    30 */    90,   89,   78,   78,   78,  104,   78,   78,
};
...
static const YYCODETYPE yyRuleInfoLhs[] = {
    24,  /* (0) program ::= */
    24,  /* (1) program ::= expr */
    24,  /* (2) program ::= expr ASS ID */
    24,  /* (3) program ::= BANG ID arglist */
    25,  /* (4) expr ::= expr MINUS expr */
    25,  /* (5) expr ::= expr PLUS expr */
    25,  /* (6) expr ::= expr TIMES expr */
    25,  /* (7) expr ::= expr DIVIDE expr */
    25,  /* (8) expr ::= expr AND expr */
    25,  /* (9) expr ::= expr OR expr */
    25,  /* (10) expr ::= expr XOR expr */
    25,  /* (11) expr ::= expr LESS expr */
    25,  /* (12) expr ::= expr LESSEQ expr */
    25,  /* (13) expr ::= expr GREATER expr */
    25,  /* (14) expr ::= expr GREATEREQ expr */
    25,  /* (15) expr ::= expr EQ expr */
    25,  /* (16) expr ::= expr NEQ expr */
    25,  /* (17) expr ::= BRO expr BRC */
    25,  /* (18) expr ::= MINUS expr */
    25,  /* (19) expr ::= NOT expr */
    25,  /* (20) expr ::= INTEGER */
    25,  /* (21) expr ::= BOOL */
    25,  /* (22) expr ::= STRING */
    25,  /* (23) expr ::= ID */
    25,  /* (24) expr ::= ID BRO arglist BRC */
    26,  /* (25) arglist ::= */
    26,  /* (26) arglist ::= expr */
    26,  /* (27) arglist ::= expr COMMA arglist */
};
...
static const signed char yyRuleInfoNRhs[] = {
    0,  /* (0) program ::= */
   -1,  /* (1) program ::= expr */
   -3,  /* (2) program ::= expr ASS ID */
   -3,  /* (3) program ::= BANG ID arglist */
   -3,  /* (4) expr ::= expr MINUS expr */
   -3,  /* (5) expr ::= expr PLUS expr */
   -3,  /* (6) expr ::= expr TIMES expr */
   -3,  /* (7) expr ::= expr DIVIDE expr */
   -3,  /* (8) expr ::= expr AND expr */
   -3,  /* (9) expr ::= expr OR expr */
   -3,  /* (10) expr ::= expr XOR expr */
   -3,  /* (11) expr ::= expr LESS expr */
   -3,  /* (12) expr ::= expr LESSEQ expr */
   -3,  /* (13) expr ::= expr GREATER expr */
   -3,  /* (14) expr ::= expr GREATEREQ expr */
   -3,  /* (15) expr ::= expr EQ expr */
   -3,  /* (16) expr ::= expr NEQ expr */
   -3,  /* (17) expr ::= BRO expr BRC */
   -2,  /* (18) expr ::= MINUS expr */
   -2,  /* (19) expr ::= NOT expr */
   -1,  /* (20) expr ::= INTEGER */
   -1,  /* (21) expr ::= BOOL */
   -1,  /* (22) expr ::= STRING */
   -1,  /* (23) expr ::= ID */
   -4,  /* (24) expr ::= ID BRO arglist BRC */
    0,  /* (25) arglist ::= */
   -1,  /* (26) arglist ::= expr */
   -3,  /* (27) arglist ::= expr COMMA arglist */
};
...
#line 1035 "src/grammar.c"
        break;
      case 4: /* expr ::= expr MINUS expr */
#line 91 "src/grammar.lg"
{ yylhsminor.yy0.val = val_sub(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1040 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 5: /* expr ::= expr PLUS expr */
#line 92 "src/grammar.lg"
{ yylhsminor.yy0.val = val_add(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1046 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 6: /* expr ::= expr TIMES expr */
#line 93 "src/grammar.lg"
{ yylhsminor.yy0.val = val_mul(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1052 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 7: /* expr ::= expr DIVIDE expr */
#line 94 "src/grammar.lg"
{ yylhsminor.yy0.val = val_div(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1058 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 8: /* expr ::= expr AND expr */
#line 96 "src/grammar.lg"
{ yylhsminor.yy0.val = val_and(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1064 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 9: /* expr ::= expr OR expr */
#line 97 "src/grammar.lg"
{ yylhsminor.yy0.val = val_or(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1070 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 10: /* expr ::= expr XOR expr */
#line 98 "src/grammar.lg"
{ yylhsminor.yy0.val = val_xor(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1076 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 11: /* expr ::= expr LESS expr */
#line 100 "src/grammar.lg"
{ yylhsminor.yy0.val = val_lt(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1082 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 12: /* expr ::= expr LESSEQ expr */
#line 101 "src/grammar.lg"
{ yylhsminor.yy0.val = val_le(yymsp[-2].minor.yy0.val, yymsp[0].minor.yy0.val); }
#line 1088 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 13: /* expr ::= expr GREATER expr */
#line 102 "src/grammar.lg"
{ yylhsminor.yy0.val = val_lt(yymsp[0].minor.yy0.val, yymsp[-2].minor.yy0.val); }
#line 1094 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 14: /* expr ::= expr GREATEREQ expr */
#line 103 "src/grammar.lg"
{ yylhsminor.yy0.val = val_le(yymsp[0].minor.yy0.val, yymsp[-2].minor.yy0.val); }
#line 1100 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 15: /* expr ::= expr EQ expr */
#line 104 "src/grammar.lg"
{ yylhsminor.yy0.val = val_eq(yymsp[0].minor.yy0.val, yymsp[-2].minor.yy0.val); }
#line 1106 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 16: /* expr ::= expr NEQ expr */
#line 105 "src/grammar.lg"
{ yylhsminor.yy0.val = val_neq(yymsp[0].minor.yy0.val, yymsp[-2].minor.yy0.val); }
#line 1112 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 17: /* expr ::= BRO expr BRC */
#line 108 "src/grammar.lg"
{ yymsp[-2].minor.yy0 = yymsp[-1].minor.yy0; }
#line 1118 "src/grammar.c"
        break;
      case 18: /* expr ::= MINUS expr */
#line 110 "src/grammar.lg"
{ yymsp[-1].minor.yy0.val = val_neg(yymsp[0].minor.yy0.val); }
#line 1123 "src/grammar.c"
        break;
      case 19: /* expr ::= NOT expr */
#line 111 "src/grammar.lg"
{ yymsp[-1].minor.yy0.val = val_not(yymsp[0].minor.yy0.val); }
#line 1128 "src/grammar.c"
        break;
...
{ 
	variable_t * var = var_byname(yymsp[0].minor.yy0.id);
	if(var == NULL) basic_error(ERR_INVALID_VAR);
	var_get(var, &yylhsminor.yy0.val);
}
#line 1145 "src/grammar.c"
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
...
#line 123 "src/grammar.lg"
{
	...
	yylhsminor.yy0.val = fun(cnt, args);
}
#line 1174 "src/grammar.c"
  yymsp[-3].minor.yy0 = yylhsminor.yy0;
        break;
      case 25: /* arglist ::= */
#line 148 "src/grammar.lg"
{ yymsp[1].minor.yy0.arg = NULL; }
#line 1180 "src/grammar.c"
        break;
      case 26: /* arglist ::= expr */
#line 150 "src/grammar.lg"
{ 
	yylhsminor.yy0.arg = basic_alloc(sizeof(arg_t));
	yylhsminor.yy0.arg->value = yymsp[0].minor.yy0.val;
	yylhsminor.yy0.arg->next = NULL;
}
#line 1189 "src/grammar.c"
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
...
{
	yylhsminor.yy0.arg = basic_alloc(sizeof(arg_t));
	yylhsminor.yy0.arg->value = yymsp[-2].minor.yy0.val;
	yylhsminor.yy0.arg->next = yymsp[0].minor.yy0.arg;
}
#line 1199 "src/grammar.c"
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      default:
        break;
